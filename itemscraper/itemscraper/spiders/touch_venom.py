...
#    allowed_domains = ["dofus.com"]
    ...
    start_urls = [
        #'https://www.dofus-touch.com/en/mmorpg/encyclopedia/equipment?page=%d' % page
        #for page in range(1, 110 + 1)
    ] + [
        #'https://www.dofus-touch.com/en/mmorpg/encyclopedia/weapons?page=%d' % page
        #for page in range(1, 40 + 1)
    ] + [
        #'https://www.dofus-touch.com/en/mmorpg/encyclopedia/pets?page=%d' % page
        #for page in range(1, 7 + 1)
    ] + [
        'https://www.dofus-touch.com/en/mmorpg/encyclopedia/mounts?page=%d' % page
