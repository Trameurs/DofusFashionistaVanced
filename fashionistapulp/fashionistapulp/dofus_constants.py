...
DAMAGE_SPELLS = {
    ...
    'Ecaflip': [
        ...
        Spell('Rekop', [200], Effects(
            ...
            [['23-0'],
             ...
             ['10-23'],
             ['10-23']],
            [AIR, WATER, FIRE, EARTH, AIR, WATER, FIRE, EARTH, AIR, WATER, FIRE, EARTH, AIR, AIR, AIR, AIR, WATER, WATER, WATER, WATER, FIRE, FIRE, FIRE, FIRE, EARTH, EARTH, EARTH, EARTH, AIR, AIR, WATER, FIRE, EARTH, AIR, WATER, FIRE, EARTH, AIR, WATER, FIRE, EARTH, WATER, FIRE, EARTH],
        ), is_linked=(2, 'Bluff')),
        ...
        Spell('Summoning Claw', [60, 127, 194], Effects(
            ...
            None,
            ['buff_pow'],
        ), stacks=3, is_linked=(1, 'Summoning Stroke')),
    ...
    'Eliotrope': [
        ...
        Spell('Pride', [170], Effects(
            ...
            None,
            ['buff_pow'],
        ), is_linked=(2, 'Distribution')),
        Spell('Cabal', [40, 107, 174], Effects(
            [['100', '150', '200']],
            None,
            ['buff_pow'],
        ), is_linked=(1, 'Resilience')),
    ...
    'Huppermage': [
        ...
        Spell('Journey', [40, 107, 174], Effects(
            ...
            [['25-34', '33-42', '41-50'],
             ...
             ['25-34', '33-42', '41-50']],
            [EARTH, FIRE, WATER, AIR],
        ), is_linked=(1, 'Runic Repulsion')),
        Spell('Contribution', [55, 122, 189], Effects(
            [['150', '150', '150']],
            None,
            ['buff_pow'],
        ), stacks=2, is_linked=(1, 'Creation')),
    ...
    'Ouginak': [
        ...
        Spell('R-Canine', [30, 97, 164], Effects(
            ...
            None,
            ['buff_pow'],
        ), stacks=2, is_linked=(1, 'Snuggletooth')),
